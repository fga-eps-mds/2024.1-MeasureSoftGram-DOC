    ...
    <tr>
        ...
        <td align="center">
            <a href="https://github.com/giovanniacg">
                <img style="border-radius: 50%;" src="https://github.com/giovanniacg.png" width="150px;"/>
                <h5 class="text-center">Giovanni Alvissus Camargo Giampauli</h5>
            </a>
        </td>
        <td align="center">
            <a href="https://github.com/guivilela7">
                <img style="border-radius: 50%;" src="https://github.com/guivilela7.png" width="150px;"/>
    ...
    <tr>
        ...
        <td align="center">
            <a href="https://github.com/murilopbs">
                ...
                <h5 class="text-center">Murilo Perazzo Barbosa Souto</h5>
            </a>
        </td>
        <td align="center">
            <a href="https://github.com/nicollaxs">
                <img style="border-radius: 50%;" src="https://github.com/nicollaxs.png" width="150px;"/>
                <h5 class="text-center">Nicollas Gabriel Oliveira Sousa</h5>
            </a>
        </td>
        <td align="center">
